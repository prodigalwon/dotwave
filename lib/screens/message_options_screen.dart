...
/// re-mint the silicon content key + republish CHAT/MESSAGE, superseding the
/// old records. Reached from the messages screen's "Message Options" button.
class MessageOptionsScreen extends StatefulWidget {
  final String address;
  final String name;
  const MessageOptionsScreen({super.key, required this.address, required this.name});

  @override
  State<MessageOptionsScreen> createState() => _MessageOptionsScreenState();
}

class _MessageOptionsScreenState extends State<MessageOptionsScreen> {
