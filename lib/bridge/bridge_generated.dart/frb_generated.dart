...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 31990316;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateChatChatGenSealRecord({required String identitySeedHex});
  ...
  Future<ChatSendOutcome> crateChatChatSendPlain({
    required String nodeRpc,
    required String senderSeedHex,
    required String recipientPubkeyHex,
    required String recipientContentKeyHex,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(recipientPqspkEkHex, serializer);
          sse_encode_String(recipientPqspkSignatureHex, serializer);
  ...
  Future<String> crateChatChatGenSealRecord({required String identitySeedHex}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateChatChatGenSealRecordConstMeta,
        argValues: [identitySeedHex],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateChatChatGenSealRecordConstMeta => const TaskConstMeta(
    debugName: "chat_gen_seal_record",
    argNames: ["identitySeedHex"],
  );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(recipientContentKeyHex, serializer);
          sse_encode_String(recipientSealRecordHex, serializer);
  ...
  Future<ChatSendOutcome> crateChatChatSendPlain({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateChatChatSendPlainConstMeta,
        argValues: [
          nodeRpc,
          senderSeedHex,
          recipientPubkeyHex,
  ...
  TaskConstMeta get kCrateChatChatSendPlainConstMeta => const TaskConstMeta(
    debugName: "chat_send_plain",
    argNames: [
      "nodeRpc",
      "senderSeedHex",
      "recipientPubkeyHex",
  ...
  DrPrekeySetup dco_decode_dr_prekey_setup(dynamic raw) {
    ...
    return DrPrekeySetup(
      ...
      pqspkEkHex: dco_decode_String(arr[2]),
      pqspkSignatureHex: dco_decode_String(arr[3]),
      opkBundleHex: dco_decode_String(arr[4]),
      opkSecrets: dco_decode_list_dr_opk_secret(arr[5]),
    );
  }
  ...
  ResolvedChatIdentity dco_decode_resolved_chat_identity(dynamic raw) {
    ...
    return ResolvedChatIdentity(
      ...
      sealRecordHex: dco_decode_String(arr[4]),
      hasSealKey: dco_decode_bool(arr[5]),
      prekeyRecordHex: dco_decode_String(arr[6]),
      hasPrekey: dco_decode_bool(arr[7]),
    );
  }
  ...
  DrPrekeySetup sse_decode_dr_prekey_setup(SseDeserializer deserializer) {
    ...
    var var_pqspkEkHex = sse_decode_String(deserializer);
    var var_pqspkSignatureHex = sse_decode_String(deserializer);
    ...
    return DrPrekeySetup(
      ...
      pqspkEkHex: var_pqspkEkHex,
      pqspkSignatureHex: var_pqspkSignatureHex,
  ...
  ResolvedChatIdentity sse_decode_resolved_chat_identity(
    ...
    var var_sealRecordHex = sse_decode_String(deserializer);
    var var_hasSealKey = sse_decode_bool(deserializer);
    var var_prekeyRecordHex = sse_decode_String(deserializer);
    var var_hasPrekey = sse_decode_bool(deserializer);
    return ResolvedChatIdentity(
      found: var_found,
      ed25519PubkeyHex: var_ed25519PubkeyHex,
      innerContentKeyHex: var_innerContentKeyHex,
      hasMessageKey: var_hasMessageKey,
      sealRecordHex: var_sealRecordHex,
      hasSealKey: var_hasSealKey,
      prekeyRecordHex: var_prekeyRecordHex,
      hasPrekey: var_hasPrekey,
    );
  }
  ...
  void sse_encode_dr_prekey_setup(
    ...
    sse_encode_String(self.pqspkEkHex, serializer);
    sse_encode_String(self.pqspkSignatureHex, serializer);
  ...
  void sse_encode_resolved_chat_identity(
    ...
    sse_encode_String(self.sealRecordHex, serializer);
    sse_encode_bool(self.hasSealKey, serializer);
    sse_encode_String(self.prekeyRecordHex, serializer);
    sse_encode_bool(self.hasPrekey, serializer);
  }
